...
extends RefCounted
## Safe, deep-copied decision snapshot for coaching, review and replay.
##
...
## malformed data.
##
## The game parameter of capture() is intentionally untyped so this module can
## be preloaded from poker_round.gd without a static cyclic class reference;
## restore() resolves PokerRound at runtime.
