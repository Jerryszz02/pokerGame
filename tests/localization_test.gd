...
func _run() -> void:
	...
	_assert(Localization.personality_label("TightAggressive") == "Tight-Aggressive", "English tight-aggressive label")
	_assert(Localization.personality_label("LooseAggressive") == "Loose-Aggressive", "English loose-aggressive label")
	_assert(Localization.personality_label("CallingStation") == "Calling Station", "English calling-station label")
	_assert(Localization.personality_label("Rock") == "Rock", "English rock label")
	_assert(Localization.personality_label("Balanced") == "Balanced", "English balanced label")
	_assert(Localization.personality_label("default") == "Default", "English default label")
	_assert(Localization.personality_label("random") == "Random", "English random label")
	_assert(Localization.personality_label("Unknown") == "Default", "unknown personality label falls back to default")
	Localization.apply_choice("zh_CN")
	_assert(tr("设置") == "设置", "Chinese translation should load")
	_assert(Localization.personality_label("TightAggressive") == "紧凶", "Chinese tight-aggressive label")
	_assert(Localization.personality_label("LooseAggressive") == "松凶", "Chinese loose-aggressive label")
	_assert(Localization.personality_label("CallingStation") == "跟注站", "Chinese calling-station label")
	_assert(Localization.personality_label("Rock") == "岩石", "Chinese rock label")
	_assert(Localization.personality_label("Balanced") == "均衡", "Chinese balanced label")
