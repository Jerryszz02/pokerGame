...
Insert the following image and section after “Turn up the table” and before the existing “Play PokerGame 1.2.0” link. Upload the image to itch.io and place it immediately before the heading. Retain the original title, cover, other sections, and release attachments.
