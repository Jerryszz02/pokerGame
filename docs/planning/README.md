...
本地教练、回放行动评估、地狱难度和六维画像的定义与验证见[coach-radar-plan.md](coach-radar-plan.md)。这些功能已随 v1.3.0 上传 itch.io；[本次发布记录](../releases/1.3.0.md)包含渠道 ID、构建来源及验证边界。下面保留 2026-09-11 的历史核对。
