...
v1.1.0 已包含教程、可配置筹码/盲注、牌谱回放和本地统计/成就。开发源码新增本地练习提示、回放决策分析、地狱难度与六维打法画像；可选的 DeepSeek 文字复盘在“设置 → AI 复盘”填写自己的 Key，仅当前会话保存、主动点击才调用。口径和验收见[教练与雷达图方案](docs/planning/coach-radar-plan.md)。这些源码变化尚未更新已发布下载。当前源码与公开发布的区别见[状态与文档索引](docs/planning/README.md)。
